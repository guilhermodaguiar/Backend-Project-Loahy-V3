...
import nl.loahy_v3.payload.AuthenticationRequest;
import nl.loahy_v3.payload.AuthenticationResponse;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody @Valid AuthenticationRequest authenticationRequest)
        ...
        try {
            ...
            throw new Exception("Incorrect e-mailadres or password", exception);
        }
