...
INSERT INTO users (email, password, enabled, user_id, first_name, last_name, address_address_id, wishlist_wishlist_id) VALUES ('user@test.nl', '$2a$12$5Opf8AKt28//iIdms4dXZuHzQTPjBmOV92SQSELfGB0g9LdmAWQ9O', TRUE,1,  'User', 'Test', 5001, 200);
INSERT INTO users (email, password, enabled, user_id, first_name, last_name, address_address_id, wishlist_wishlist_id) VALUES ('admin@test.nl', '$2a$12$lgPKHPD.92GF8Dd8gjH.TeBh9O5SzlmipOpbUiqRHKVbjg7HgZj.S', TRUE,2,  'Admin', 'Test', 5002, 203);
INSERT INTO users (email, password, enabled, user_id, first_name, last_name, address_address_id, wishlist_wishlist_id) VALUES ('jenfromlomok@test.nl', '$2a$12$BmMv.oCR96Hcw81S7yoW/uNPBGPADmdBI45EZS6I1tlq3FwTv3Ncu', TRUE,3, 'Jen', 'van Lombok', 5003, 202);
INSERT INTO users (email, password, enabled, user_id, first_name, last_name, address_address_id, wishlist_wishlist_id) VALUES ('guilfromlombok@test.nl', '$2a$12$v8obCBMrcCq6s9qBRAUEZuWAK9oSWSn1JzceR7/BWt3UnN643QMOW', TRUE,4, 'Guil', 'Dag', 5004, 201);
