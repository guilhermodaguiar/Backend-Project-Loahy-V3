...
INSERT INTO users (user_email, password, user_id, first_name, last_name, enabled, address_address_id, wishlist_wishlist_id) VALUES ('user@test.nl', '$2a$12$5Opf8AKt28//iIdms4dXZuHzQTPjBmOV92SQSELfGB0g9LdmAWQ9O', 400,  'User', 'Test', true, 5001, 200);
INSERT INTO users (user_email, password, user_id, first_name, last_name, enabled, address_address_id, wishlist_wishlist_id) VALUES ('admin@test.nl', '$2a$12$kFPBcSnUNJ/Ojs.m8ko//uV44D0ZhGUyOZQVzux36l5y8JFJLXOdG', 401,  'Admin', 'Test', true, 5002, 201);
INSERT INTO users (user_email, password, user_id, first_name, last_name, enabled, address_address_id) VALUES ('jenfromlomok@test.nl', '$2a$12$BmMv.oCR96Hcw81S7yoW/uNPBGPADmdBI45EZS6I1tlq3FwTv3Ncu', 403, 'Jen', 'van Lombok', true, 5003);
INSERT INTO users (user_email, password, user_id, first_name, last_name, enabled, address_address_id) VALUES ('Guilfromlombok@test.nl', '$2a$12$v8obCBMrcCq6s9qBRAUEZuWAK9oSWSn1JzceR7/BWt3UnN643QMOW', 404, 'Guil', 'Dag', true, 5004);
